...
class StockItemConfiguration(db.Model):
    ...
    stock_level_id = db.Column(db.String(36), db.ForeignKey('stock_level.id'))
    stock_level_last_updated_on_utc = db.Column(db.DateTime(timezone=True), server_default=func.now())