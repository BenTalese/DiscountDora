...
class ProductHistoricOfferModel(db.Model):
    ...
    @classmethod
    def from_entity(cls, product_historic_offer: ProductHistoricOffer) -> 'ProductHistoricOfferModel':
        _Model = cls()
        _Model.id = product_historic_offer.id.value
        _Model.offered_on = product_historic_offer.offered_on
        _Model.price_now = product_historic_offer.price_now
        _Model.price_was = product_historic_offer.price_was
