...
export const THEMES: Record<string, ThemeOption> = {
    ...
    'pesto': {
        ...
        palette: {
            primary: 'hsl(150, 76%, 39%)', secondary: 'hsl(189, 100%, 26%)', accent: 'hsl(50, 99%, 56%)',
            ...
            text: 'hsl(168, 28%, 12%)', disabled: 'hsl(168, 8%, 60%)',
            border: 'hsl(168, 18%, 84%)', divider: 'hsl(168, 14%, 86%)', focus: 'hsl(150, 76%, 39%)',
        },
        isDark: false,
    },
    'pesto-dark': {
        ...
        palette: {
            primary: 'hsl(150, 75%, 55%)', secondary: 'hsl(170, 28%, 30%)', accent: 'hsl(150, 75%, 55%)',
            page: 'hsl(165, 60%, 5%)', component: 'hsl(170, 28%, 12%)',
            positive: 'hsl(150, 75%, 55%)', negative: 'hsl(7, 78%, 65%)',
            info: 'hsl(218, 80%, 70%)', warning: 'hsl(33, 95%, 65%)',
            text: 'hsl(225, 100%, 93%)', disabled: 'hsl(205, 10%, 50%)',
            border: 'hsl(205, 12%, 28%)', divider: 'hsl(205, 12%, 24%)', focus: 'hsl(150, 75%, 55%)',
        },
        isDark: true,
    },
    ...
    'lemon-tart-dark': {
        ...
        palette: {
            ...
            info: 'hsl(218, 80%, 70%)', warning: 'hsl(46, 100%, 55%)',
