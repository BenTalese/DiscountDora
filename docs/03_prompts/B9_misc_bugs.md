...
4. ~~**Command palette (Ctrl+K)** doesn't trigger some actions (e.g. "create stock item"). Find the palette command registry; wire the missing/ broken commands.~~ **CANCELLED 2026-06-12** — palette retired entirely (see worklog + FU-029); the bug class no longer exists.
